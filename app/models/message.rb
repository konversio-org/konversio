...
class Message < ApplicationRecord
  searchkick callbacks: false if KonversioApp.advanced_search_allowed?
  ...
  def should_index?
    return false unless KonversioApp.advanced_search_allowed?
    ...
    return false if KonversioApp.chatwoot_cloud? && !account.feature_enabled?('advanced_search_indexing')
