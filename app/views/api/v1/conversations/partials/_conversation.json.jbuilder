...
json.suggested_label_ids conversation.suggested_label_ids
json.partial! 'enterprise/api/v1/conversations/partials/conversation', conversation: conversation if KonversioApp.enterprise?
