...
// The upstream `onClose` deprecation warning was removed in the Konversio
// fork. Both `:on-close` (prop) and `@close` (event) work; ~34 callsites
// still use the prop and a migration is out of scope. Re-enable here if we
// ever pick up that refactor.
</script>
